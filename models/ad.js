...
ad.add({
    ...
    state:                  { type: Types.Select,       default: 'CREATE', required: true, options: [{ value: 'CREATE', label: '创建中' }, { value: 'OPEN', label: '可用' }, { value: 'DEFAULT', label: '青橙官方' }, { value: 'DELIVER', label: '投放中' }, { value: 'SUCESS', label: '完成' }, { value: 'CANCEL', label: '取消授权' }, { value: 'NO_BALANCE', label: '余额不足' }], label: '状态'},
